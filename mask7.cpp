...
enum {
  ...
  BUT78,
  BUT910,
  COMBOCENTER, // combobox for the production center
	FRAME5,
	  FRAME5TITLE,
	    LABFRAME5TITLE,
	FRAME5_A,
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQComboBox(p,COMBOCENTER,CENTRALFORM,0,AtBottom);
  pvSetGeometry(p,COMBOCENTER,40,170,300,40);
  pvSetFont(p,COMBOCENTER,"Default",12,1,0,0,0);
  pvHide(p,COMBOCENTER);
