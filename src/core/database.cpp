...
void loadCars(char*& sql,std::vector<std::vector<std::string>> dataReturn)
{
  ...
  newQuery = "insert into vehiculos (CODIGO_VEHICULO, MATRICULA, VEHICULO_REMOLQUE, TARA, PMA, CODIGO_CLIENTE1, CODIGO_CLIENTE2, CODIGO_CLIENTE3, CODIGO_CLIENTE4, CODIGO_CLIENTE5, CODIGO_CLIENTE6, CODIGO_CLIENTE7, CODIGO_CLIENTE8, CODIGO_CLIENTE9, CODIGO_CLIENTE10"
...
{
  sql = new char[sizeof("select CODIGO_VEHICULO,MATRICULA,VEHICULO_REMOLQUE ,TARA , PMA ,CODIGO_CLIENTE1 , CODIGO_CLIENTE2 ,CODIGO_CLIENTE3 ,CODIGO_CLIENTE4 ,CODIGO_CLIENTE5,CODIGO_CLIENTE6 , CODIGO_CLIENTE7 ,CODIGO_CLIENTE8 ,CODIGO_CLIENTE9 ,CODIGO_CLIENTE10"
                        ",CODIGO_CLIENTE11 , CODIGO_CLIENTE12 ,CODIGO_CLIENTE13 ,CODIGO_CLIENTE14 ,CODIGO_CLIENTE15,CODIGO_CLIENTE16 , CODIGO_CLIENTE17 ,CODIGO_CLIENTE18 ,CODIGO_CLIENTE19 ,CODIGO_CLIENTE20"
                        ",CODIGO_CLIENTE21 , CODIGO_CLIENTE22 ,CODIGO_CLIENTE23 ,CODIGO_CLIENTE24 ,CODIGO_CLIENTE25,CODIGO_CLIENTE26 , CODIGO_CLIENTE27 ,CODIGO_CLIENTE28 ,CODIGO_CLIENTE29 ,CODIGO_CLIENTE30 from vehiculos WHERE (BORRADO is null or BORRADO = 0);")+32];
  sprintf(sql,"select CODIGO_VEHICULO,MATRICULA,VEHICULO_REMOLQUE ,TARA , PMA ,CODIGO_CLIENTE1 , CODIGO_CLIENTE2 ,CODIGO_CLIENTE3 ,CODIGO_CLIENTE4 ,CODIGO_CLIENTE5,CODIGO_CLIENTE6 , CODIGO_CLIENTE7 ,CODIGO_CLIENTE8 ,CODIGO_CLIENTE9 ,CODIGO_CLIENTE10"
            ",CODIGO_CLIENTE11 , CODIGO_CLIENTE12 ,CODIGO_CLIENTE13 ,CODIGO_CLIENTE14 ,CODIGO_CLIENTE15,CODIGO_CLIENTE16 , CODIGO_CLIENTE17 ,CODIGO_CLIENTE18 ,CODIGO_CLIENTE19 ,CODIGO_CLIENTE20"
